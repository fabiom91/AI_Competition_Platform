...
function load_feed(feedname) {
  ...
  if (feedname == "create_article") {
    alert(
      "Apologies, the function to create NEW articles or competitions have been temporarily disabled. If you wish to join an existing competition, please click on its thumbnail on the Dashboard. If you need help, contact support@your_support_email.com"
    );
  } else {
...
$(document).ready(function () {
  $("#register_button").click(function () {
    document.getElementById("modal_title").innerHTML = "Welcome to ***";
    document.getElementById("log_reg_description").innerHTML =
      ...
      .catch(function (error) {
        alert(
          "Sorry, an error has occur: " +
            error +
            " If you think your account has been deleted without your permission, please, contact us immediately at: support@your_support_email.com"
        );
      });
  } else {
